<?php
	...
	R::setup( 'mysql:host=s3.ho.ua;dbname=drendoo','drendoo', '8zhar3gY4s' ); //Создание подключения с базой данных. 1.Хост. 2.Название базы данных 3. Имя пользователя 4.Пароль
